        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card card-item">
                    ...
                    <form method="POST" class="card-body" id="add_question" action="{{ route('question.store') }}">
                        @csrf
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="tags[]" multiple="multiple">
                                    <option value="-1" disabled selected>chooess</option>
                                    @foreach($tags as $tag)
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                form--control " rows="10" cols="40"></textarea>
                                {{-- user-text-editor --}}
