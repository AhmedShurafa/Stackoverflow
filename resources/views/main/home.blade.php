            ...
            <div class="col-lg-2 pr-0">
                <div class="sidebar pb-45px position-sticky top-0">
                    <ul class="generic-list-item generic-list-item-highlight fs-15">
                        ...
                        <li class="lh-26 @if(Route::is('main') || Route::is('home')) active @endif"><a href="{{ route('main') }}"><i class="la la-globe mr-1 text-black"></i> Questions</a></li>
                        <li class="lh-26 @if(Route::is('tags')) active @endif"><a href="{{ route('tags') }}"><i class="la la-tags mr-1 text-black"></i> Tags</a></li>
                        <li class="lh-26 @if(Route::is('users')) active @endif"><a href="{{ route('users') }}"><i class="la la-user mr-1 text-black"></i> Users</a></li>
                        <li class="lh-26 @if(Route::is('all.badges')) active @endif"><a href="{{ route('all.badges') }}"><i class="la la-id-badge mr-1 text-black"></i> Badges</a></li>
            ...
            <div class="col-lg-7 px-0">
                ...
                <div class="question-main-bar border-left border-left-gray pb-50px">
                    <div class="filters pb-4 pl-3 d-flex align-items-center justify-content-between">
                        ...
                        @auth
                            <div class="hero-btn-box py-4">
                                <a href="{{ route('question.create') }}" class="btn theme-btn mr-2">Ask a Question <i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
                        @endauth
                    ...
                    <div class="questions-snippet border-top border-top-gray">
                        ...
                        <div class="media media-card rounded-0 shadow-none mb-0 bg-transparent p-3 border-bottom border-bottom-gray">
                            <div class="votes text-center votes-2">
                                ...
                                @php
                                    $answer = 'no';
                                    foreach ($value->answers as $answered) {
                                        if($answered->accepted == "yes"){
                                            $answer = 'yes';
                                            break;
                                        }else {
                                            $answer = 'no';
                                ...
                                @endphp
                                <div class="answer-block @if($answer == 'yes') answered-accepted @else answered @endif my-2">
                            ...
                            <div class="media-body">
                                ...
                                <p class="mb-2 truncate lh-20 fs-15">{{ Str::limit($value->description , 30 , '...') }}</p>
                                <div class="tags">
                                ...
                                <div class="media media-card user-media align-items-center px-0 border-bottom-0 pb-0">
                                    <a href="{{ route('profile', $value->user->id) }}" class="media-img d-block">
                                        <img src="{{ asset($value->user->profile->image)}}" alt="avatar">
                                    </a>
                                    <div class="media-body d-flex flex-wrap align-items-center justify-content-between">
                                        <div>
                                            <h5 class="pb-1"><a href="{{ route('profile', $value->user->id) }}">{{ $value->user->name }}</a></h5>
                        ...
                        @empty
                            <p class="text-center h3">Not Found</p>
                        @endforelse
...
<section class="cta-area pt-80px pb-80px bg-radial-gradient-gray">
    <div class="container">
        <div class="cta-heading media align-items-center justify-content-center">
            <img src="{{ asset('assets/images/undraw-team-up.svg')}}" alt="undraw-questions" class="undraw-illustration mr-5">
