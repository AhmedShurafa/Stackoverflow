                    ...
                    <div class="hero-content">
                        <div class="media media-card align-items-center shadow-none p-0 mb-0 rounded-0 bg-transparent">
                            <div class="media-img media--img">
                                <img src="{{ asset($user->profile->image) }}" alt="avatar">
                            </div>
                ...
                @auth
                    ...
                    <div class="col-lg-4">
                        <div class="hero-btn-box text-right py-3">
                            <a href="{{ route('edit.profile', Auth::user()->id)}}" class="btn theme-btn theme-btn-outline theme-btn-outline-gray"><i
                                class="la la-gear mr-1"></i>
                                Edit Profile
                            </a>
                        </div>
                    </div><!-- end col-lg-4 -->
                        ...
                        <div class="tab-pane fade show active" id="user-profile" role="tabpanel"
                            ...
                            <div class="user-panel-main-bar">
                                <div class="user-panel mb-30px">
                                    {{-- <p class="pb-2">I am a programmer. My principal language is C++. I've also done
                                        commercial work in Java, C, Perl, Python, Javascript and APL. I've also been
                                        known to dabble in lisp, Haskell, assembler (ARM, x86, amd64) and probably a few
                                        other languages that haven't left as big a mark.</p>
                                    <p class="pb-2">Programmer at <a href="#"
                                            class="text-color hover-underline">Bloomberg</a>. Posts and commments are my
                                        opinions and are not sponsored or endorsed by my employer.</p>
                                    <p>If my answers helped you can <a href="#" class="text-color hover-underline">buy
                                            me a coffee.</a>
                                    </p> --}}
                                ...
                                <div class="user-panel mb-30px">
                                    <div class="bg-gray p-3 rounded-rounded">
                                        <h3 class="fs-17">Top tags
                                            {{-- <span>(865) - </span> --}}
                                        </h3>
                                    </div>
                                    <div class="vertical-list">
                                        @forelse ($user->questions as $value)

                                        <div class="item tags d-flex align-items-center justify-content-between">
                                            <div class="flex-grow-1">
                                                <a href="#" class="tag-link tag-link-md tag-link-blue mb-0">
                                        ...
                                        @empty
                                            <p class="h4 mt-3 text-center">Not Found Tags For this user</p>
                                        @endforelse
                                ...
                                <div class="user-panel mb-30px">
                                    ...
                                    <div class="vertical-list">
                                        ...
                                        @endif
                                        @empty
                                            <p class="h4 mt-3 text-center">Not Found Questions For this user</p>
                                        @endforelse
                                ...
                                <div class="user-panel mb-40px">
                                    ...
                                    <div class="user-stats d-flex flex-wrap align-items-center">
                                        <div class="stat flex-grow-1 my-1">
                                            ...
                                            <span class="badge badge-md badge-gray"><span class="ball"></span>
                                                function-pointers</span>
                                        </div>
                                        ...
                                        <div class="vertical-list">
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">How to make
                                                                Git “forget” about a file that was tracked but is now in
                                                                .gitignore?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">Undoing a git
                                                                rebase</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">Difference
                                            ...
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">How to find
                                                                and restore a deleted file in a Git repository</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">Branch from a
                                                                previous commit using Git</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                        ...
                                        <div class="vertical-list">
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">What are the
                                                                correct version numbers for C#?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">Curious
                                            ...
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">What's your
                                                                most controversial programming opinion?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">Performance
                                            ...
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">What's the
                                                                strangest corner case you've seen in C# or .NET?
                                                                [closed]</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                    ...
                                    <div class="summary-panel">
                                        <div class="vertical-list">
                                            ...
                                            <div class="item tags d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="tag-link tag-link-md tag-link-blue mb-0 lh-20">java</a>
                                                </div>
                                                <span class="item-multiplier fs-14">
                                                    <span>×</span>
                                                    <span>10512</span>
                                            ...
                                            <div class="item tags d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="tag-link tag-link-md tag-link-blue mb-0 lh-20">.net</a>
                                                </div>
                                                <span class="item-multiplier fs-14">
                                                    <span>×</span>
                                                    <span>5569</span>
                                            ...
                                            <div class="item tags d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="tag-link tag-link-md tag-link-blue mb-0 lh-20">linq</a>
                                                </div>
                                                <span class="item-multiplier fs-14">
                                                    <span>×</span>
                                                    <span>2982</span>
                                            ...
                                            <div class="item tags d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="tag-link tag-link-md tag-link-blue mb-0 lh-20">string</a>
                                                </div>
                                                <span class="item-multiplier fs-14">
                                                    <span>×</span>
                                                    <span>999</span>
                                        ...
                                        <div class="vertical-list">
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">git: undo all
                                                                working dir changes including new files</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">How to revert
                                                                uncommitted changes including files and folders?</a>
                                                        </h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">Detected
                                            ...
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">What is the
                                            ...
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="question-details.html">I've found a
                                                                bug in the JIT/CLR - now how do I debug or reproduce
                                                                it?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                        ...
                                        <div class="vertical-list">
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5><a href="question-details.html"
