...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Jul 2021 10:17:48 GMT -->
<head>
...
<section class="login-area pt-80px pb-80px position-relative">
    ...
    <div class="container">
        <form action="{{ route('login') }}" method="POST" class="card card-item login-form">
            @csrf
            <div class="card-body row p-0">
                <div class="col-lg-6">
                    <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/images/undraw-remotely.svg')}}" alt="Image" class="img-fluid">
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        ...
                        <div class="form-group">
                            ...
                            class="form-control form--control @error('email') is-invalid @enderror" placeholder="Email address">
                            @error('email')
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between">
                            ...
                            @if (Route::has('password.request'))
                                ...
                                class="btn-text fs-14 hover-underline fw-regular">Forgot Password?</a>
                            @endif
                            </div><!-- end form-group -->
                        <div class="form-group">
