...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/signup-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Jul 2021 10:17:48 GMT -->
<head>
                ...
                <div class="col-lg-6">
                    <div class="form-content p-5 h-100 d-flex align-items-center justify-content-center flex-column bg-diagonal-gradient-primary-2 radius-top-left-8 radius-bottom-left-8 text-left">
                        ...
                        <div class="w-100">
                            ...
                            <a href="{{ route('login') }}" class="btn theme-btn theme-btn-white px-5 lh-24">Log in</a>
                        </div>
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" name="name" class="form-control form--control @error('name') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18" id="password-confirm">{{ __('Confirm Password') }}</label>
                            <div class="input-group mb-1">
                                <input class="form-control form--control password-field @error('password') is-invalid @enderror"
                                type="password" name="password_confirmation" placeholder="Password" required autocomplete="new-password">
